...
$("#albert").on("click",function(){
	var sound = new Howl({src: ['albert.mp3']}).play();
});

$("#blup").on("click",function(){
	var sound = new Howl({src: ['blup.mp3']}).play();
});

$("#fed").on("click",function(){
	var sound = new Howl({src: ['feed.mp3']}).play();
});

$("#hungry").on("click",function(){
	var sound = new Howl({src: ['hungry.mp3']}).play();
});

$("#jaime").on("click",function(){
	var sound = new Howl({src: ['jeimi.mp3']}).play();
});

$("#nani").on("click",function(){
	var sound = new Howl({src: ['nani.mp3']}).play();
});

$("#okay").on("click",function(){
	var sound = new Howl({src: ['okay.mp3']}).play();
});

$("#omg").on("click",function(){
	var sound = new Howl({src: ['omg.mp3']}).play();
});
